...
EOF
    ...
    echo -e "SimuID\tNB_RAD_FRAG\tREP\tINDIV\tTP\tTN\tFP\tFN" > ./TFPN_Rates_PLINK/LargeArray/Rates/LargeArray_${SimID}_${REP}_TF_PN_Rates_GEN1000.txt
    ...
    do
        ...
        echo -e "${SimID}\tLargeArray\t${REP}\t${INDIV}\t${TP}\t${TN}\t${FP}\t${FN}" >> ./TFPN_Rates_PLINK/LargeArray/Rates/LargeArray_${SimID}_${REP}_TF_PN_Rates_GEN1000.txt
...
#List the files
FILES=./TFPN_Rates_PLINK/LargeArray/Rates/LargeArray_*_TF_PN_Rates_GEN1000.txt
#Create header
echo -e "SimID\tNB_RAD_FRAG\tREP\tINDIV\tTP\tTN\tFP\tFN" > ./Analyses/LargeArray_PLINK_TFPN_Rates_GEN1000.txt
#Add the files
for f in $FILES; do awk 'NR > 1 {print $0}' $f >> ./Analyses/LargeArray_PLINK_TFPN_Rates_GEN1000.txt; done
